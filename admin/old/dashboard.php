...
<div class="container py-4">
    ...
    <div class="alert alert-info mb-4"
        style="background: linear-gradient(135deg, #154c79, #1565a0); border: none; color: white;">
                    ...
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <small class="text-muted">Rp
                                <?php echo number_format($transactionStats['total_amount'] ?: 0, 0, ',', '.'); ?></small>
                        </div>
...
document.getElementById('checkPhoneBtn').addEventListener('click', function() {
    ...
    resultDiv.innerHTML =
        '<div class="text-center"><i class="fas fa-spinner fa-spin"></i> Mengecek nomor...</div>';
    resultDiv.style.display = 'block';
