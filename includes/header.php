...
<head>
    ...
    <link rel="icon" href="<?php echo isset($basePath) ? $basePath : ''; ?>assets/images/logo-loyalin.png"
        type="image/png">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark">
        <div class="container">
            <a class="navbar-brand" href="<?php echo isset($basePath) ? $basePath : ''; ?>index.php">
                <img src="<?php echo isset($basePath) ? $basePath : ''; ?>assets/images/logo-loyalin.png" alt="Loyalin">
