    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 mb-3 mb-md-0">
                ...
                <p class="small text-muted mb-0">Membantu UMKM meningkatkan loyalitas pelanggan dengan sistem poin digital yang mudah dan efektif.</p>
            </div>
            ...
            <div class="col-md-5 mb-3 mb-md-0">
                ...
                <ul class="list-unstyled">
                    ...
                    <li class="mb-2">
                        <a href="<?php echo isset($basePath) ? $basePath : ''; ?>login.php" class="text-light text-decoration-none">
                            <i class="fas fa-sign-in-alt me-2"></i>Login
                        </a>
                    </li>
                    <li class="mb-2">
                        <a href="<?php echo isset($basePath) ? $basePath : ''; ?>register.php" class="text-light text-decoration-none">
