...
<head>
    ...
    <title>Daftar - <?php echo $siteName; ?></title>
    ...
    <div class="container register-container">
        <div class="card">
            <div class="card-header text-center">
                <div class="auth-logo">
                    <img src="assets/images/logo-sate.png" alt="Logo">
                </div>
                <h3>Daftar Akun Baru</h3>
                <p class="text-muted small mb-0">Bergabung dengan Program Loyalitas UMKM</p>
            </div>
                ...
                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                    ...
                    <div class="mb-3">
                        ...
                        <div class="business-list-container" id="businessList">
                            ...
                            <div class="business-select-card"
                                data-business-name="<?php echo strtolower($business['business_name']); ?>"
                                ...
                                <input type="radio" name="business_id" id="business_<?php echo $business['id']; ?>"
                                    ...
                                    <?php echo $businessId == $business['id'] ? 'checked' : ''; ?> required>
                                <label class="business-select-label" for="business_<?php echo $business['id']; ?>">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            <div class="fw-bold">
                                                <?php echo htmlspecialchars($business['business_name']); ?></div>
        ...
        <div class="text-center mt-4 text-white">
            ...
            <p class="small">Sistem Loyalitas untuk UMKM Indonesia</p>
        </div>
    </div>
